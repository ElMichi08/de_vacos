...
class _OrderFormWidgetState extends State<OrderFormWidget> {
  ...
  void _incrementarCantidadProducto(String claveAgrupacion) {
    ...
    setState(() {
      ...
      _productosSeleccionados.add(ProductoSeleccionado(
        ...
        acompanantes: productoBase.acompanantes.map((a) => AcompananteSeleccionado(
          nombre: a.nombre,
  ...
  Future<void> _editarGrupoProducto(String claveAgrupacion) async {
    ...
    final productoBase = grupo['producto'] as ProductoSeleccionado;
    final producto = widget.productos.firstWhere((p) => p.id == productoBase.productoId);
      ...
      setState(() {
        ...
        for (int i = 0; i < cantidad; i++) {
          _productosSeleccionados.add(ProductoSeleccionado(
            ...
            acompanantes: resultado.acompanantes.map((a) => AcompananteSeleccionado(
              nombre: a.nombre,
              precioAdicional: a.precioAdicional,
              cantidad: a.cantidad,
            )).toList(),
  ...
  Future<void> _agregarProducto(Producto producto) async {
    ...
    if (!producto.tieneVariantes && !producto.tieneAcompanantes && !producto.tieneExtras) {
      setState(() {
        _productosSeleccionados.add(ProductoSeleccionado(
  ...
  Future<ProductoSeleccionado?> _mostrarDialogoConfigurarProducto(
    ...
    final Map<String, double> preciosAcompanantes = {}; // nombre -> precio adicional
    ...
    if (productoSeleccionadoExistente != null) {
      // Cargar variante
      if (productoSeleccionadoExistente.varianteNombre != null && producto.tieneVariantes) {
      ...
      for (var acompananteSel in productoSeleccionadoExistente.acompanantes) {
        acompanantesCantidades[acompananteSel.nombre] = acompananteSel.cantidad;
        preciosAcompanantes[acompananteSel.nombre] = acompananteSel.precioAdicional;
      }
              ...
              children: [
                ...
                if (producto.tieneVariantes) ...[
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: producto.variantes!.map((variante) {
                ...
                if (producto.tieneAcompanantes) ...[
                  Row(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final cantidadCortes = varianteSeleccionada != null 
                              ? int.tryParse(varianteSeleccionada!.nombre.split(' ').first) ?? 1
                              : 1;
                          final totalAcompanantes = acompanantesCantidades.values.fold<int>(0, (sum, cant) => sum + cant);
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              color: isValid ? AppColors.successDark.withValues(alpha: 0.2) : AppColors.error.withValues(alpha: 0.2),
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(
                                color: isValid ? AppColors.successDark : AppColors.error,
                                width: 1,
                              ),
                            ),
                            child: Row(
                  ...
                  ...producto.acompanantes!.map((acompanante) {
                    final cantidadActual = acompanantesCantidades[acompanante.nombre] ?? 0;
                    return Card(
                                ...
                                children: [
                                  ...
                                  Text(
                                    acompanante.precioAdicional > 0
                                        ...
                                        : 'Gratis',
                                    style: TextStyle(
                                      color: acompanante.precioAdicional > 0 ? AppColors.price : Colors.white70,
                                      fontSize: 12,
                                    ),
                                  ),
                                ],
                                ...
                                IconButton(
                                  ...
                                  onPressed: cantidadActual > 0
                                      ? () {
                                          setDialogState(() {
                                            if (cantidadActual > 1) {
                                              acompanantesCantidades[acompanante.nombre] = cantidadActual - 1;
                                            } else {
                                              acompanantesCantidades.remove(acompanante.nombre);
                                              preciosAcompanantes.remove(acompanante.nombre);
                                            }
                                          });
                                        }
                                      : null,
                                ...
                                Builder(
                                  builder: (context) {
                                    final cantidadCortes = varianteSeleccionada != null 
                                        ...
                                        : 1;
                                    final totalAcompanantes = acompanantesCantidades.values.fold<int>(0, (sum, cant) => sum + cant);
                                    final puedeAgregar = totalAcompanantes < cantidadCortes;
                                    return IconButton(
                                      ...
                                      onPressed: puedeAgregar
                                          ? () {
                                              setDialogState(() {
                                                acompanantesCantidades[acompanante.nombre] = (cantidadActual) + 1;
                                                preciosAcompanantes[acompanante.nombre] = acompanante.precioAdicional;
                                              });
                                            }
                                          : null,
                                    );
                ...
                if (producto.tieneExtras) ...[
                  ...
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Row(
                      children: producto.extras!.map((extra) {
                          ...
                          child: FilterChip(
                            ...
                            onSelected: (selected) {
                              setDialogState(() {
                                ...
                                preciosExtras.clear();
                                preciosExtras[extra.nombre] = extra.precioAdicional;
                              });
                            },
                            selectedColor: AppColors.accent,
                            checkmarkColor: Colors.white,
          ...
          actions: [
            ...
            Row(
              ...
              children: [
                  ...
                  onPressed: () {
                    ...
                    if (producto.tieneAcompanantes) {
                      ...
                      if (totalAcompanantes != cantidadCortes) {
                        setDialogState(() {
                          mensajeError = 'Debes seleccionar exactamente $cantidadCortes acompañante${cantidadCortes > 1 ? 's' : ''} (actual: $totalAcompanantes)';
                        });
                        return;
                      }
                    }
                ...
                double precioBase = varianteSeleccionada?.precio ?? producto.precio;
                double precioExtrasTotal = preciosExtras.values.fold(0.0, (sum, precio) => sum + precio);
                
                // Crear lista de acompañantes seleccionados
                // La cantidad de cada acompañante se mantiene según lo seleccionado
                final acompanantesList = acompanantesCantidades.entries
                    .map((entry) => AcompananteSeleccionado(
                          nombre: entry.key,
                          precioAdicional: preciosAcompanantes[entry.key] ?? 0.0,
                          cantidad: entry.value, // Mantener la cantidad seleccionada
                        ))
                    .toList();
                    ...
                    final productoSeleccionado = ProductoSeleccionado(
                      ...
                      extrasNombres: extraSeleccionado != null ? [extraSeleccionado!] : [],
  ...
  double _calcularTotal() {
    double total = 0;
    for (var productoSeleccionado in _productosSeleccionados) {
  ...
  void _guardar() {
    ...
    final pedido = Pedido(
      ...
      numeroOrden: widget.pedido?.numeroOrden ?? 0, // Mantener número de orden si es edición
      cliente: _clienteController.text.trim(),
      celular: _celularController.text.trim(),
      metodoPago: _metodoPago,
      estado: widget.pedido?.estado ?? 'En preparación', // Mantener estado si es edición
      estadoPago: widget.pedido?.estadoPago ?? 'Pendiente', // Mantener estado de pago si es edición
      productos: _obtenerProductosLista(),
      fecha: widget.pedido?.fecha ?? DateTime.now(), // Mantener fecha original si es edición
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final cantidadInstancias = _productosSeleccionados.where((p) => p.productoId == producto.id).length;
                  return ListTile(
                ...
                children: [
                  ...
                  if (_productosSeleccionados.isEmpty)
                    ...
                    ..._obtenerProductosAgrupados().entries.map((entry) {
                      ...
                      final productoSeleccionado = grupo['producto'] as ProductoSeleccionado;
                      ...
                      return Padding(
                        ...
                        child: Slidable(
                          ...
                          endActionPane: ActionPane(
                            ...
                            children: [
                              SlidableAction(
                                onPressed: (context) => _eliminarGrupoProducto(claveAgrupacion),
                          ...
                          child: Card(
                            ...
                            child: InkWell(
                              onTap: () => _editarGrupoProducto(claveAgrupacion),
                              borderRadius: const BorderRadius.only(
                                topLeft: Radius.circular(AppConstants.borderRadius),
                                bottomLeft: Radius.circular(AppConstants.borderRadius),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (productoSeleccionado.varianteNombre != null ||
                                        ...
                                        productoSeleccionado.extrasNombres.isNotEmpty) ...[
                                      const SizedBox(height: 8),
                                      if (productoSeleccionado.varianteNombre != null)
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Icon(Icons.straighten, size: 14, color: Colors.white54),
                                      ...
                                      if (productoSeleccionado.acompanantes.isNotEmpty)
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Icon(Icons.restaurant_menu, size: 14, color: Colors.white54),
                                              const SizedBox(width: 6),
                                              Expanded(
                                                child: Text(
                                                  productoSeleccionado.acompanantes.map((a) => a.nombre).join(", "),
                                                  style: const TextStyle(color: Colors.white70, fontSize: 12),
                                                ),
                                              ),
                                            ],
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        IconButton(
                                          icon: const Icon(Icons.remove, color: Colors.white, size: 20),
                                          onPressed: () => _decrementarCantidadProducto(claveAgrupacion),
                                        ),
                                        Container(
                                        ...
                                        IconButton(
                                          icon: const Icon(Icons.add, color: Colors.white, size: 20),
                                          onPressed: () => _incrementarCantidadProducto(claveAgrupacion),
                                        ),
                                      ],
                                    ),
                                  ],
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      widget.pedido != null ? 'Actualizar Pedido' : 'Guardar Pedido',
                      style: const TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
